...
export class AgentViewProvider implements vscode.WebviewViewProvider {
    ...
    private getHtmlContent(webview: vscode.Webview): string {
        ...
        return [
            ...
            '</head>',
            '<body>',
            '    <div id="historyBackdrop" class="history-backdrop" onclick="closeHistoryDrawer()"></div>',
            '    <div id="historyDrawer" class="history-drawer">',
            '        <div class="history-drawer-header">',
            '            <span class="history-drawer-title">📜 Conversation History</span>',
            '            <button class="history-close-btn" onclick="closeHistoryDrawer()" title="Close">✕</button>',
            '        </div>',
            '        <div class="history-search-box">',
            '            <input id="historySearchInput" type="text" placeholder="Search conversations..." oninput="filterSessions(this.value)" />',
            '        </div>',
            ...
            '            <button class="icon-btn" title="View past conversations" onclick="openHistoryDrawer()">',
            '                📜 History',
            '            </button>',
            '            <button class="icon-btn" title="Start new conversation" onclick="startNewChat()">',
            '                ➕ New',
            '            </button>',
